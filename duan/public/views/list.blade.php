...
<head>
  ...
  <title>Quản Trị Web - Danh sách Sản Phẩm</title>
</head>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <div class="card-body p-0">
                                    ...
                                    @endif
                                    <div class="bangsp">
                                        <table class="table table-striped mb-0" style="width: 500px">
                                            <thead style="background-color: #1a5fc7; text-align:center;color:white">
                                                <tr>
                                                    ...
                                                    <th>Tác giả</th>
                                                    <th>Ngày đăng</th>
                                                    <th style="width:50px">Tóm tắt</th>
                                                    <th>Danh mục</th>
                                                    <th>Chuc nang</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('edit/'.$data->id)}}" title="Sua"><button
                                                                type="button" class="btn btn-success"  style="margin-bottom:20px ">Sửa</button></a>
                                                        <a href="{{url('del/'.$data->id)}}" onclick="return confirm('Ban muon xoa san pham?')" title="Xoa"><button
                                                                type="button" class="btn btn-info">Xóa</button></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
