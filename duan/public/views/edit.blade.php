...
<head>
  ...
  <title>Quản Trị Web - Sửa Sản Phẩm</title>
</head>
    ...
    <div class="formbold-main-wrapper">
        <div class="formbold-form-wrapper">
            ...
            <form action="{{url('/update/'.$product->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="formbold-input-flex">
                    <div>
                        <input type="text" name="nhacungcap" value="{{$product->nhacungcap}}" id="nhacungcap" placeholder="Nhập Nhà Cung Cấp"
                            class="formbold-form-input" />
                        <label for="name" class="formbold-form-label"> Nhà cung cấp</label>
                    </div>
                    <div>
                        <input type="text" name="nhaxuatban" id="nhaxuatban" value="{{$product->nhaxuatban}}" placeholder="Nhập nhà xuất bản"
                            class="formbold-form-input" />
                ...
                <div class="formbold-input-flex">
                    <div>
                        <input type="text" name="tacgia" id="tacgia" value="{{$product->tacgia}}" placeholder="Nhập Tên tác giả"
                            class="formbold-form-input" />
                        <label for="name" class="formbold-form-label"> Tác giả</label>
                    </div>
                    <div>
                        <input type="date" name="ngayDang" id="ngayDang" value="{{$product->ngayDang}}" placeholder="Nhập ngày đăng"
                            class="formbold-form-input" />
