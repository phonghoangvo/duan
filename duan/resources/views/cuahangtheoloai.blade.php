...
<div class="container pt-3 pb-3 px-0">
                ...
                <div class="row p-3">
                    ...
                    <div class="col-md-6 col-xl-3 p-2 sanpham ">
                        <div class="boxsanpham  p-2">
                            ...
                            <div class="gia">
                                <span>{{number_format($product->price)}} đ</span><br>
                                <p><del>{{number_format($product->priceSale)}} đ</del></p>
                            </div>
                        </div>
                    </div>
                    @endforeach
    ...
    <div>
        <nav class="pagination">
            ...
            <a href="#" class="pagination__page">{{$products->onEachSide(5)->links()}}</a>
            {{-- {{$ds_tin->onEachSide(5)->links()}}  --}}
          </nav>
    </div>
