            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="collapseThree"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{url('/comment/list')}}">Tất Cả Bình Luận</a>
                        <a class="collapse-item" href="utilities-border.html">Thêm Bình Luận</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <a href="{{url('add')}}" class="btn btn-success mb-4">Thêm sản phẩm</a>
