                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="card-body p-1 mx-3">
                                        <div class="d-flex">
                                            <h5 class="card-title">gd</h5> - <small class="p-1">dsg</small>
                                        </div>
                                        <div>
                                ...
                                <p class="card-text border-bottom">sdg</p>
                                    
                                {{-- @endforeach --}}
                            </div>
                            <div class="col-lg-6">
                                <form method="POST ">
                                    {{-- @csrf action="{{url('comment')}} --}}
                ...
                <div class="row pt-2 pb-2">
                    <div class="col-xl-2 col-sm-4 p-1 px-1">
                        <div class="card border-1">
                            <img class="card-img-top" width="200px" height="200px" src="/uploads/{{$hot[0]->img}}" alt="{{$hot[0]->img}}">
                            <div class="middle">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row d-flex">
                                    ...
                                    <div class="col-sm-2">
                                        <button type="button" class="btn btn-primary float-end px-2" style="padding: 5px 10px;border-radius: 50%;">
                    ...
                    <div class="col-xl-2 col-sm-4 p-1 px-1">
                        <div class="card border-1">
                            <img class="card-img-top" width="200px" height="200px" src="/uploads/{{$hot[1]->img}}" alt="{{$hot[1]->img}}">
                            <div class="middle">
                                <a href="#" class="btn btn-light zoom border-0">
                                    <i class=" bi bi-zoom-in"></i>
                                </a>
                    ...
                    <div class="col-xl-2 col-sm-4 p-1 px-1">
                        <div class="card border-1">
                            <img class="card-img-top" width="200px" height="200px" src="/uploads/{{$hot[2]->img}}" alt="{{$hot[2]->img}}">
                            <div class="middle">
                                <a href="#" class="btn btn-light zoom border-0">
                                    <i class=" bi bi-zoom-in"></i>
                                </a>
                    ...
                    <div class="col-xl-2 col-sm-4 p-1 px-1">
                        <div class="card border-1">
                            <img class="card-img-top" width="200px" height="200px" src="/uploads/{{$hot[3]->img}}" alt="{{$hot[3]->img}}">
                            <div class="middle">
                                <a href="#" class="btn btn-light zoom border-0">
                                    <i class=" bi bi-zoom-in"></i>
                                </a>
                    ...
                    <div class="col-xl-2 col-sm-4 p-1 px-1">
                        <div class="card border-1">
                            <img class="card-img-top" width="200px" height="200px" src="/uploads/{{$hot[4]->img}}" alt="{{$hot[4]->img}}">
                            <div class="middle">
                                <a href="#" class="btn btn-light zoom border-0">
                                    <i class=" bi bi-zoom-in"></i>
                                </a>
                    ...
                    <div class="col-xl-2 col-sm-4 p-1 px-1">
                        <div class="card border-1">
                            <img class="card-img-top" width="200px" height="200px" src="/uploads/{{$hot[5]->img}}" alt="{{$hot[5]->img}}">
                            <div class="middle">
                                <a href="#" class="btn btn-light zoom border-0">
                                    <i class=" bi bi-zoom-in"></i>
                                </a>
